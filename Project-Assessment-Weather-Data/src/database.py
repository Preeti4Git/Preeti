...
class Database:
    ...
    # This method updates the data in a document.
    def update_single_data(self, collection, filter, update):
        db_collection = self._db[collection]
        document = db_collection.update_one(filter, update)
        return document.acknowledged

    # This method deletes the data from collection based on key.
    def delete_single_data(self, collection, filter):
        db_collection = self._db[collection]
        document = db_collection.delete_one(filter)
        return document.acknowledged

    # This method aggregates the data from collection based on key.
